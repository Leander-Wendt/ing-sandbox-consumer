...
# production environment using the eIDAS certificates. Please replace the     #
#certificates in the script with your eIDAS certificates    	 			  #
###############################################################################


keyId="SN=546212fb" # Serial number of eIDAS certificate in hexadecimal code
